...
class OenologistMagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist_magazine" do
    assert_difference('OenologistMagazine.count') do
      post oenologist_magazines_url, params: { oenologist_magazine: { magazine: @oenologist_magazine.magazine, oenologist_id: @oenologist_magazine.oenologist_id } }
    end
  ...
  test "should update oenologist_magazine" do
    patch oenologist_magazine_url(@oenologist_magazine), params: { oenologist_magazine: { magazine: @oenologist_magazine.magazine, oenologist_id: @oenologist_magazine.oenologist_id } }
