class OenologistMagazinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @oenologist_magazine.save
        format.html { redirect_to oenologist_magazine_url(@oenologist_magazine), notice: "Oenologist magazine was successfully created." }
  ...
  def update
    respond_to do |format|
      if @oenologist_magazine.update(oenologist_magazine_params)
        format.html { redirect_to oenologist_magazine_url(@oenologist_magazine), notice: "Oenologist magazine was successfully updated." }
  ...
  private
    ...
    def oenologist_magazine_params
      params.require(:oenologist_magazine).permit(:oenologist_id, :magazine)
    end
end
